...
class plgHikashoppaymentXmrpay extends hikashopPaymentPlugin
{
    ...
    public $pluginConfig = array(
        ...
        'network'            => array('XMRPAY_NETWORK', 'list', 'mainnet', array('mainnet' => 'mainnet', 'stagenet' => 'stagenet', 'testnet' => 'testnet')),
        'min_confirmations'  => array('XMRPAY_MIN_CONFIRMATIONS', 'input', '10'),
        'index_offset'       => array('XMRPAY_INDEX_OFFSET', 'input', '0'),
        'rate_source'        => array('XMRPAY_RATE_SOURCE', 'list', 'coingecko', array('coingecko' => 'CoinGecko (automatic)', 'fixed' => 'Fixed rate', 'custom' => 'Custom price URL')),
